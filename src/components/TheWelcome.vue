...
function onEnter(event) {
    ...
    var keys=event.target.value+"\r"
    var myJSObject={keys : keys};

  
    axios.post('http://192.168.1.12:5050/api/keys',myJSObject).then(resp => {
...
<template>
  <WelcomeItem>
    ...
    <input
      ...
      @keyup.enter="onEnter" 
    /> 
    <button @click="keyboardshow">ShowKeyboard.</button>
